// lib/presentation/budget/budget_page.dart
...
class BudgetPage extends StatelessWidget {
        ...
        return Scaffold(
          ...
          body: budgets.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    final b = budgets[i];
                    final keyId = budgets[i].key;

                    // Hitung pemakaian berdasarkan transaksi
                    final used = tx
  ...
  /// CARD ITEM
  // ============================================================
  Widget _budgetCard(BuildContext context, BudgetModel b, double used,
      double progress, int keyId) {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // EDIT: pass only the existing model (no keyId param)
              IconButton(
                ...
                onPressed: () {
                  showModalBottomSheet(
                    ...
                    backgroundColor: Colors.transparent,
                    isScrollControlled: true,
                    // NOTE: BudgetEditor constructor expected here only `existing` (based on your editor)
                    builder: (_) => BudgetEditor(
                      existing: b,
                    ),
                  );
                },
